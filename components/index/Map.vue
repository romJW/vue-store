<template>
  <div class="relative">
    <div
      class="card bg-white rounded-lg border border-gray-200 shadow-md p-4 !hidden md:!flex flex-col absolute z-10 bg-white justify-center p-4 2xl:p-10 gap-4 top-10 left-10 2xl:left-80"
    >
      <div>
      ...
      <div>
        <span
          ...
          class="cursor-pointer italic text-sky-700 underline"
        >
